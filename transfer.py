...
# ***** 需要你补充的变量) ******
manual_model_to_smpl = {0:0, 1:1, 2:3, 3:2, 4:4, 5:6, 6:5, 7:7, 8:9, 9:8, 10:10, 11:14, 12:12, 13:13, 14:11, 15:17, 17:16, 18:19, 19:15, 20:18, 21:21, 39:20}
...
def transfer_given_pose(human_pose, infoname, is_root_rotated=False): 
    ...
    os.makedirs("./pose2carton/results", exist_ok=True)
    save_dict = {
        "infoname": infoname, 
        "hier": new_hier, 
    ...
    with open(osp.join("pose2carton/results", str(infoname).replace(".txt", ".pkl").replace('/', '_')), "wb") as f: 
...
def transfer_one_frame(infofile, use_online_model=False): 
    ...
    with open("./pose2carton/pose_sample.pkl", "rb") as f: 
        # poses shape: (N, 24, 3)
        poses = pkl.load(f)
...
if __name__ == '__main__':
    ...
    # for provided models
    # transfer_one_frame("pose2carton/fbx/18020.txt")
    # transfer_one_sequence("pose2carton/fbx/18020.txt", "pose2carton/info_seq_5.pkl")

    # for possible model downloaded online
    # clean_info("samples/Ch14_nonPBR.txt")
    transfer_one_frame("pose2carton/fbx/zombie.txt", use_online_model=True)
    transfer_one_sequence("pose2carton/fbx/zombie.txt", "pose2carton/info_seq_5.pkl", use_online_model=True)