...
savedir = "pose2carton/vis/"
os.makedirs(savedir, exist_ok=True)
save_video_path = osp.join(savedir, "vis.mp4")
human_obj_dir = "pose2carton/obj_seq_5"
...
for idx in tbar: 
    ...
    # visualizer.capture_screen_image(osp.join("vis", "{}.png".format(idx)), do_render=False)
    vis_save_path = osp.join(savedir, str(idx) + ".png")
    # img = np.asarray(visualizer.capture_screen_float_buffer()).copy()
    visualizer.capture_screen_image(vis_save_path, False)
